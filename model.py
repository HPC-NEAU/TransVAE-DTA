...
class attention_pooling_layer(nn.Module):
    def __init__(self, dropout_rate=0.1, feature_dim=96):
    ...
    def forward(self, q, v):
        ...
        a = v.view(v.shape[0], self.heads, v.shape[1] // self.heads, -1)
        b = q.view(q.shape[0], self.heads, q.shape[-1] // self.heads, -1)
        a1 = a.transpose(2, 3)
        b1 = b.transpose(2, 3)
